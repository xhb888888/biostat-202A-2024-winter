...
$\frac{X_1-1}{\sqrt{\sum_{i=1}^{2}(\frac{X_i-i}{i})^2/2}}\sim t_2$
...
$\frac{(X_1-1)^2}{\sum_{i=1}^{2}(\frac{X_i-i}{i})^2/2}\sim F_{1,2}$
...
$M_W(t)=M_{X^2+2Y^2}(t)=E[e^{X^2t+2Y^2t}]=E[e^{X^2t}]E[e^{2Y^2t}]=2M_{X^2}(t)M_{Y^2}(t)$
...
$M_{Y^2}(t)=\frac{1}{(1-2t)^{1/2}}$, t\<1/2

$M_W(t)=2M_{X^2}(t)M_{Y^2}(t)=\frac{2}{1-2t}$, t\<1/2
...
$M_{X_2}(t)=\frac{M_Y(t)}{M_{X_1}(t)}=e^{\mu(e^t-1)-\mu_1(e^t-1)}=e^{(\mu-\mu_1)(e^t-1)}$
...
$f_X{x}=\frac{1}{\sqrt{2\pi}\sigma}e^{-\frac{(x-\mu)^2}{2\sigma^2}}$ with support: $-\infty<x<\infty$
...
$E[Y^k]=\int_{0}^{\infty}y^kf_Y(y)dy=\int_{0}^{\infty}y^k\frac{1}{\sqrt{2\pi}\sigma}e^{-\frac{(log(y)-\mu)^2}{2\sigma^2}}\frac{1}{y}dy=\int_{0}^{\infty}y^{k-1}\frac{1}{\sqrt{2\pi}\sigma}e^{-\frac{(log(y)-\mu)^2}{2\sigma^2}}dy$
